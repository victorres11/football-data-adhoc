...
def calculate_successful_run_rate():
    ...
    with open('../data/maryland/maryland_rush_attempts_corrected.json', 'r') as f:
        plays = json.load(f)
    ...
    with open('../data/maryland/maryland_successful_runs_analysis.json', 'w') as f:
    ...
    print(f"\nResults saved to: ../data/maryland/maryland_successful_runs_analysis.json")
