#!/usr/bin/env python3
"""
Create comprehensive ESPN vs CFBD comparison for game 401752873
"""
...
def extract_espn_plays(espn_data):
    ...
    if 'drives' in espn_data and 'items' in espn_data['drives']:
        for drive in espn_data['drives']['items']:
...
def create_comparison_html(espn_plays, cfbd_plays):
    ...
    <head>
        ...
        <title>ESPN vs CFBD Data Comparison - Michigan vs Washington (401752873)</title>
        <style>
            body {{
    ...
    <body>
        ...
        <div class="summary">
            <div class="summary-card">
                ...
                <p><strong>Data Structure:</strong> Nested in drives</p>
...
def main():
    ...
    print("Creating ESPN vs CFBD comparison for game 401752873...")
    ...
    # Save HTML
    output_file = 'espn_cfbd_comparison_401752873.html'
