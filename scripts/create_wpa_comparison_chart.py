#!/usr/bin/env python3
"""
Create WPA comparison chart with ESPN vs CFBD data
"""

import json

def create_wpa_comparison_chart():
    """Create WPA comparison chart with ESPN vs CFBD data"""
    
    print("🔍 Creating WPA comparison chart...")
    
    # Load ESPN data
    with open('espn_pbp_with_wpa_401752873.json', 'r') as f:
    ...
    for i, play in enumerate(espn_data):
        if 'espn_wpa' in play and play['espn_wpa']['wpa_percentage'] is not None:
            espn_wpa_data.append(play['espn_wpa']['wpa_percentage'])
...
<head>
    ...
    <title>WPA Comparison: ESPN vs CFBD - Game 401752873</title>
...
<body>
    <div class="header">
        <h1>📊 WPA Comparison: ESPN vs CFBD</h1>
        ...
        const chart = new Chart(ctx, {{
            ...
            options: {{
                ...
                plugins: {{
                    title: {{
                        display: true,
                        text: 'Win Probability Added (WPA) Comparison: ESPN vs CFBD'
                    }},
                    legend: {{
                        display: true,
                        position: 'top'
...
"""
    ...
    # Save HTML file
    with open('wpa_comparison_chart_401752873.html', 'w') as f:
        f.write(html_content)
    
    print("✅ Created WPA comparison chart")
    print("📄 File: wpa_comparison_chart_401752873.html")
