#!/usr/bin/env python3
"""
Fix WPA data in actual table rows
"""

import json
import re

def fix_wpa_in_table_rows():
    """Fix WPA data in actual table rows"""
    
    print("🔍 Fixing WPA data in actual table rows...")
    ...
    # Look for the specific pattern with class="play-number"
